...
#define	LCD_D4 		PORTB0// lcd pin 11
#define	LCD_D5 		PORTB1// lcd pin 12
#define LCD_D6 		PORTB2// lcd pin 13
#define	LCD_D7 		PORTB3// lcd pin 14

#define	LCD_RS		PORTB6// lcd pin 4
#define	LCD_EN		PORTB4// lcd pin 6
#define	LCD_RW		PORTB5// lcd pin 5
...
#ifdef DEBUG
void flashPD4(const uint8_t count) {
	DDRD = _BV(PORTD4);
...
void flashPD5(const uint8_t count) {
	DDRD = _BV(PORTD5);
	for(int i = 0; i < count; i++) {
		PORTD |= _BV(PORTD5);
		_delay_ms(0xFF);
